...
function pCb37CiUQ(mIgmYeO22, oI6vgg) {
    var aXvh = 'cd300c05a92cd35f993d5e7cce9e6fba';
    var cxgy0 = 'WEB';
    var tgXrOA7 = new Date().getTime();
    var pa2vEF0 = {
        appId: aXvh,
        method: mIgmYeO22,
        timestamp: tgXrOA7,
        clienttype: cxgy0,
        object: oI6vgg,
        secret: hex_md5(aXvh + mIgmYeO22 + tgXrOA7 + cxgy0 + JSON.stringify(osDgRSkgtX(oI6vgg)))
    };
    pa2vEF0 = BASE64.encrypt(JSON.stringify(pa2vEF0));
    return pa2vEF0
}
...
function gGsackEJz3k2oTh0(key, period) {
...
mIgmYeO22 = 'GETMONTHDATA'
var pa2vEF0 = pCb37CiUQ(mIgmYeO22, ozMAMIf10e);
console.log(pa2vEF0)

var kaRR = hex_md5(mIgmYeO22 + JSON.stringify(ozMAMIf10e));
var daXBf = gGsackEJz3k2oTh0(kaRR, 6);
console.log(daXBf)
